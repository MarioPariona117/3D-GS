...
\definecolor{deep_blue}{rgb}{0.0, 0.2, 0.4}
\definecolor{teal_green}{rgb}{0.0, 0.5, 0.5}
\definecolor{steel_blue}{rgb}{0.27, 0.51, 0.71}
\definecolor{slate_gray}{rgb}{0.44, 0.5, 0.56}

% Customize chapter and section formatting
\titleformat{\chapter}[hang]{\normalfont\Large\bfseries\color{deep_blue}}{\thechapter}{1em}{}[\titlerule]
\titleformat{\section}[hang]{\normalfont\large\bfseries\color{teal_green}}{\thesection}{1em}{}
\titleformat{\subsection}[hang]{\normalfont\large\bfseries\color{steel_blue}}{\thesubsection}{1em}{}
\titleformat{\subsubsection}[hang]{\normalfont\large\bfseries\color{slate_gray}}{\thesubsubsection}{1em}{}
...
\includegraphics[width = \linewidth]{screenshots/original_optimization_and_densification}
...
\includegraphics[width = \linewidth]{screenshots/clone}
...
\begin{center}
\begin{minipage}{0.4\linewidth}
\includegraphics[width = \linewidth]{screenshots/split}
...
\begin{center}
\begin{minipage}{0.6\linewidth}
\includegraphics[width = \linewidth]{screenshots/clone_algo}
